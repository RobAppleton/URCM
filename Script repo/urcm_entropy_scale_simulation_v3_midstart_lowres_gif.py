...
# REM:
# REM: Name: urcm_entropy_scale_simulation_v3_midstart_lowres_gif.py
...
# Animation and file save section (GIF output)
# ani = animation.FuncAnimation(fig, update, frames=len(entropies), blit=True)
# ani.save("urcm_entropy_scale_simulation_v3_midstart_lowres.gif", writer='pillow', fps=10, dpi=80)

# REM: END OF SIMULATION
# REM:
# REM: If the GIF shows entropy rising and collapsing twice, with scale factor oscillating 
